...
export default function BookmarkAndLikesSignedin({ recipe, user, showText }: Props) {
    ...
    useEffect(() => {
        if (isBookmarked) {
            ...
            setTimeout(() => setRecentlyBookmarked(false), 2000)
        }
    }, [isBookmarked])
    ...
    useEffect(() => {
        if (isLiked) {
            ...
            setTimeout(() => setRecentlyLiked(false), 2000)
        }
    }, [isLiked])
    ...
    return (
        <div className="mt-2 flex sm:flex-col1">
            ...
            >
                <div>
                    { recentlyBookmarked && <Image src={'/animations/fireworks-animation.gif'} alt={''} width={100} height={100} className='-ml-[35px] -mt-8 absolute'/> }
            ...
            >
                <div>
                    { recentlyLiked && <Image src={'/animations/fireworks-animation.gif'} alt={''} width={100} height={100} className='-ml-[35px] -mt-8 absolute'/> }
