...
export default function Error404Page({ reset }: { reset: () => void }) {
    return (
        <div className="bg-gray-100 h-screen justify-center">
            <div className="pt-24 m-auto flex flex-col h-screen my-auto items-center">
                <svg className="animate-bounce" enableBackground="new 0 0 226 249.135" height="249.135" id="Layer_1"
                     overflow="visible" version="1.1" viewBox="0 0 226 249.135" width="226"><circle cx="113" cy="113" fill="#FFE585" r="109"/>
                    <line enableBackground="new    " fill="none" opacity="0.29" stroke="#6E6E96"
                          strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="88.866" x2="136.866"
                          y1="245.135" y2="245.135"/>
                    <line enableBackground="new    " fill="none" opacity="0.17" stroke="#6E6E96"
                          strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="154.732" x2="168.732"
                          y1="245.135" y2="245.135"/>
                    <line enableBackground="new    " fill="none" opacity="0.17" stroke="#6E6E96"
                          strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="69.732" x2="58.732"
                          y1="245.135" y2="245.135"/>
                ...
                <div className=" tracking-widest mt-4">
                    <span className="text-gray-500 text-6xl block text-center"><span>4  0  4</span></span>
                    <span className="text-gray-500 text-xl text-center">Sorry, we couldn't find what you are looking for!</span>
