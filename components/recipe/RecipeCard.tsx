...
export default function RecipeCard({ recipes, quickview }: Props) {
              ...
              <div className="flex items-center">
                <div className="w-0 flex-1">
                  <dl>
                    ...
                    <dd>
                        <div className="text-sm text-gray-900 opacity-70"><ReactMarkdown>{recipe.description}</ReactMarkdown></div>
                    </dd>
                  </dl>
                </div>
              </div>
